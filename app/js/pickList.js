   ...
   $.fn.pickList = function (options) {
      ...
      this.init = function () {
         var pickListHtml =
                 ...
                 "	<div> <button  class='pAdd btn btn-primary btn-sm' type='button'>" + opts.add + "</button> </div>" +
                 "  <div> <button  class='pAddAll btn btn-primary btn-sm' type='button'>" + opts.addAll + "</button> </div>" +
                 "	<div> <button  class='pRemove btn btn-primary btn-sm' type='button'>" + opts.remove + "</button> </div>" +
                 "	<div> <button  class='pRemoveAll btn btn-primary btn-sm' type='button'>" + opts.removeAll + "</button> </div>" +
                 " </div>" +
                 " <div class='col-sm-5'>" +
